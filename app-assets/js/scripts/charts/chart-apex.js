...
$(function () {
  ...
  var areaChartEl = document.querySelector('#line-area-chart'),
    areaChartConfig = {
      ...
      colors: [chartColors.area.series4,chartColors.area.series3, chartColors.area.series2, chartColors.area.series1],
      // colors:['#F44336', '#E91E63', '#9C27B0', '#EA8D4D'],
      series: [
        {
          name: 'Converssion',
          data: [100, 120, 90, 170, 130, 160, 140, 280, 220, 180, 270, 380, 475]
        },
        {
          name: 'Ad Clicks',
        ...
        {
          name: 'Ad Cost',
          data: [20, 40, 30, 70, 40, 60, 50, 100, 80, 90, 100, 110, 180]
        } 
      ],
      xaxis: {
        categories: [
  ...
  var scatterChartEl = document.querySelector('#scatter-chart'),
    scatterChartConfig = {
      ...
      colors: [window.colors.solid.warning, window.colors.solid.primary, window.colors.solid.success, window.colors.solid.danger],
      series: [
        {
          name: 'High',
          data: [
  ...
  var donutChartEl = document.querySelector('#donut-chart'),
    donutChartConfig = {
      ...
      labels: ['Impressions', 'Clicks', 'Leads Created', 'Lead Conveted'],
      series: [85, 16, 50, 50],
      colors: [
