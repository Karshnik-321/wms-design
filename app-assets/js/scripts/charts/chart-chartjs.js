...
$(window).on('load', function () {
  ...
  if (barChartEx2.length) {
    var barChartExample = new Chart(barChartEx2, {
      ...
      data: {
        ...
        datasets: [
          {
            data: [275, 30, 90, 205, 125, 185, 55, 187, 127, 150, 230, 280, 190],
            barThickness: 15,
  ...
  if (polarAreaChartEx.length) {
    var polarExample = new Chart(polarAreaChartEx, {
      ...
      data: {
        labels: ['30M Impressions', '130K Clicks', '2.3K Leads Created', '900 Lead Converted', '34 Opp won'],
        datasets: [
          {
