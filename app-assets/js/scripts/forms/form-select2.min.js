...
function formatState (state) {
  ...
  //   <img src="app-assets/images/portrait/small/avatar-s-20.jpg" class="avatar avatar-sm" width="20" alt="avatar">
    var baseUrl = "app-assets/images/avatars"; 
    var $state = $(
      '<div class="avatar avatar-sm text-black bg-white align-items-center"><img alt="avatar" class="me-1"/> <span></span></div>'
    );
